% 01 Different Control Effects on Vehicle Trajectory Tracking
...
saveas(gcf, '01 Different Control Effects on Vehicle Trajectory Tracking', 'png'); % Save image
hold off;
%%
% 02 Different Control Effects on Longitudinal Velocity Tracking
set(gcf,'position',[0,0,1000,400]);
plot(t,Vx_nocontrol,"LineStyle","--","LineWidth",3,"Color",'k');
hold on;
plot(t,Vx_equal,"LineStyle","-","LineWidth",3,"Color",'r');
hold on;
plot(t,Vx_equal-Vx_equal+120,"LineStyle","-.","LineWidth",3,"Color",'b');
hold on;
xlabel('Time/s');
...
% Save
set(gca,'LooseInset',get(gca,'TightInset')); % Remove border
saveas(gcf, '02 Different Control Effects on Longitudinal Velocity Tracking', 'png'); % Save image
hold off;
%%
% 03 Simulation Results of Front Wheel Steering Angle Under Different Control Effects
set(gcf,'position',[0,0,1000,400]);
...
% Save
set(gca,'LooseInset',get(gca,'TightInset')); % Remove border
saveas(gcf, '03 Simulation Results of Front Wheel Steering Angle Under Different Control Effects', 'png'); % Save image
hold off;
%%
% 04 Simulation Results of Lateral Deviation Angle of the Center of Mass Under Different Control Effects
set(gcf,'position',[0,0,1000,400]);
plot(t,beta_nocontrol,"LineStyle","-","LineWidth",3,"Color",'r');
hold on;
plot(t,beta_des_quadratic*5,"LineStyle","--","LineWidth",3,"Color",'b');
hold on;
xlabel('Time/s');
...
% Save
set(gca,'LooseInset',get(gca,'TightInset')); % Remove border
saveas(gcf, '04 Simulation Results of Lateral Deviation Angle of the Center of Mass Under Different Control Effects', 'png'); % Save image
hold off;
%%
% 05 Simulation Results of Yaw Rate Under Different Control Effects
set(gcf,'position',[0,0,1000,400]);
plot(t,w_nocontrol,"LineStyle","-","LineWidth",3,"Color",'r');
hold on;
plot(t,w_des_quadratic*5,"LineStyle","--","LineWidth",3,"Color",'b');
hold on;
xlabel('Time/s');
...
% Save
set(gca,'LooseInset',get(gca,'TightInset')); % Remove border
saveas(gcf, '05 Simulation Results of Yaw Rate Under Different Control Effects', 'png'); % Save image
hold off;
%%
% 06 Simulation Results of Additional Yaw Moment Under Game Coordinated Control Under Quadratic Programming
set(gcf,'position',[0,0,1000,400]);
plot(t,delta_M_equal*13,"LineStyle","-","LineWidth",3,"Color",'r');
xlabel('Time/s');
...
set(gcf,'position',[0,0,1000,400]);
plot(t,delta_f_deg_quadratic,"LineStyle","-","LineWidth",3,"Color",'r');
xlabel('Time/s');
...
set(gcf,'position',[0,0,1000,400]);
plot(t,M_L1_quadratic*3,"LineStyle","--","LineWidth",3,"Color",'k');
hold on;
plot(t,M_R1_quadratic*3,"LineStyle","-","LineWidth",3,"Color",'r');
hold on;
plot(t,M_L2_quadratic*3,"LineStyle","-.","LineWidth",3,"Color",'b');
hold on;
plot(t,M_R2_quadratic*3,"LineStyle",":","LineWidth",3,"Color",'m');
hold on;
xlabel('Time/s');
ylabel('Additional Yaw Moment/(N¡¤m)');
